...
class CheckInsControllerTest < ActionController::TestCase
  ...
  test "should create check_in" do
    assert_difference('CheckIn.count') do
      post :create, check_in: { first_name: @check_in.first_name, last_name: @check_in.last_name, time: @check_in.time }
    end
  ...
  test "should update check_in" do
    patch :update, id: @check_in, check_in: { first_name: @check_in.first_name, last_name: @check_in.last_name, time: @check_in.time }
    assert_redirected_to check_in_path(assigns(:check_in))
  end
